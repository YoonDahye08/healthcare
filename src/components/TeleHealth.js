  ...
  return (
    <div className="fullscreen-container">
      ...
      <img
        ...
        onClick={() =>
          window.open(
            'https://console.dialogflow.com/api-client/demo/embedded/359291b7-497e-4037-9d93-1080a5d3b03c',
            'window_name',
            'width=600, height=700, location=no, status=no, scrollbars=yes'
          )
        }
      />
